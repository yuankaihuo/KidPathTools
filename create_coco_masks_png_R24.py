...
if __name__ == "__main__":
    ...
    xml_dir = '/media/huoy1/48EAE4F7EAE4E264/Projects/from_haichun/R24_scan_slides_manual_QA'
    output_dir = '/media/huoy1/48EAE4F7EAE4E264/Projects/from_haichun/coco-like-R24'
    ...
    for i in range(10, 11): #14
        ...
        roi_count = save_cropped_img_mask_good_bad(img, mask, output_dir, create_number_per_image, img_size, fname)
        roi_counts[basename] = roi_count

        try:
            roi_count2 = save_cropped_img_mask_good_bad(img, bad_mask, output_dir, create_number_per_image, img_size, fname+'_bad', 'bad')
            roi_counts[basename] = roi_count2
        except:
            continue
