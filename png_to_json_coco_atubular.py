...
INPUT_ROOT_DIR = '/media/huoy1/MyDrive/pathology/coco-like_atubular/train_roi'
MASK_ROOT_DIR = '/media/huoy1/MyDrive/pathology/coco-like_atubular/labels_roi'

ROOT_DIR = '/media/huoy1/MyDrive/pathology/data/temp_atubular'


INFO = {
    "description": "KidneyPath Dataset Mouse",
    "url": "http",
    "version": "0.1.0",
    "year": 2019,
...
def main():
    ...
    sublist['train'] = ['13-260','13-315','14-102','14-106','14-107','14-77','14-7X','189553']
    sublist['validation'] = ['14-50','189550']
    sublist['test'] = ['14-103','14-105-2X','189552']
    ...
    for type in types:
        ...
        for root, _, files in os.walk(INPUT_ROOT_DIR):
            ...
            json_files = os.path.join(ROOT_DIR,'kidneymouse_%s2019.json'%type)
            ...
            for image_filename in image_files:
                ...
                subname = os.path.basename(image_filename).split('-x-')[0]
