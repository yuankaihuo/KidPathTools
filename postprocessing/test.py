...
if __name__ == "__main__":
    ...
    for fi in range(len(sublist)):
        ...
        # auto_bboxs[fi] = {}
        if fi == 0:
            auto_bboxs[1][1] = det_obj.xml_to_box(auto_xml_file, 'auto', 200,  fi*30000)
            manual_bboxs[1][1] = det_obj.xml_to_box(manual_xml_file, 'manual',  200, fi*30000)
        else:
            auto_bboxs[1][1] = auto_bboxs[1][1] + det_obj.xml_to_box(auto_xml_file, 'auto', 200, fi*30000)
            # manual_bboxs[fi] = {}
            manual_bboxs[1][1] = manual_bboxs[1][1] + det_obj.xml_to_box(manual_xml_file, 'manual', 200, fi*30000)
