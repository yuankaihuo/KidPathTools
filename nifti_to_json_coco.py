...
INPUT_ROOT_DIR = '/home/yuankai/Projects/CT_liver/CVPR/preprocessing/Crop_48_256_176/data_deeds_2000subs'
MASK_ROOT_DIR = '/home/yuankai/Projects/CT_liver/CVPR/preprocessing/Crop_48_256_176/mask_deeds_2000subs'

ROOT_DIR = '/home/yuankai/Projects/CT_liver/CVPR/data/cgmh200'


INFO = {
    "description": "cgmh200 Dataset",
    "url": "http",
    "version": "0.1.0",
    "year": 2019,
...
def main():
    ...
    json_list = '/home/yuankai/Projects/CT_liver/CVPR/Json/segmentation_list.json'
    sublist = {}
    sublist['train'] = filedict_from_json(json_list, 'training_fold%s' % fold)
    sublist['val'] = filedict_from_json(json_list, 'val_fold%s' % fold)

    phases = ['non-contrast','arterial_phase','venous_phase','delay_phase']
    types = ['train','val']
    ...
    for type in types:
        ...
        json_files = os.path.join(ROOT_DIR,'cgmh200_%s2019.json'%type)
        ...
        for ii in range(len(image_files)):
            ...
            if not if_in_dict(sublist[type], subname):
                continue
            else:
